ActiveAdmin.setup do |config|
  ...
  config.site_logo = "dmp_logo.png"

  # Set the link url for the title. For example, to take 
  # users to your main site. Defaults to no link.
  #
  config.site_title_link = :frontpage
  ...
  config.current_organisation_method = :current_organisation
  ...
  #
  config.before_filter :admin_authorize!
