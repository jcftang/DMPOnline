...
* Bug Reports & Feature Requests: https://github.com/DigitalCurationCentre/dmponline3/issues
...
== Tools Being Used
DMPOnline is built using a number of other open source projects

Active Admin::
  A framework fir creating administration-style interfaces.
Formtastic::
...
Copyright (c) 2012 Digital Curation Centre, University of Edinburgh. See LICENSE for details.
